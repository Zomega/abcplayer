...
public class SequencePlayer {
	...
	private static int DEFAULT_CHANNEL = 0; // midi channel - for our purpose
											// always 0
	 ...
	 *            the number of beats per minute, where each beat is equal to a
	 *            quarter note in duration
	 ...
	 * step 10 for half the duration of a quarter note.
	 */
